...
export default function PoliticasPage() {
  ...
  const isLoadingAll = isLoadingPoliticas || isLoadingProcesos || isLoadingActividades || isLoadingAreas || isLoadingDepartamentos;
